...
# @Author : 20866
# @IDE : PyCharm
# @File : PycharmProject/SaveEveryComment.py
# @Description : 
...
if __name__ == '__main__':
    file_path = r'/毕业设计/毕业设计/源代码/copyDirectory/CourseComment.txt'
    all_line_txt_list = []
    ...
    try:
        work_book = app.books.open('../../../../text_file/testPackage/testDirectory/text.xlsx')
