...
# @Author : 20866
# @IDE : PyCharm
# @File : PycharmProject/ParticipateNumber.py
# @Description : 说明文件功能
...
def get_numbers() -> list:
    ...
    for i in range(0, 2):
        ...
        for item in all_item:
            ...
            time.sleep(1)
            participate = pro.get_participate_num(pro)
            participate_numbers.append(participate)
    ...
    return participate_numbers


if __name__ == '__main__':
    numbers = get_numbers()
    with open('ParticipateNumber1.txt', 'w', encoding='utf-8') as fp:
        for item in numbers:
            fp.write(item)
            fp.write('\n')
    print('participate numbers save successfully.')
