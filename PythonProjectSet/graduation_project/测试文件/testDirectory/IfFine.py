# -*- coding: utf-8 -*-
# @CreateTime : 2023/2/15 13:57
# @Author : 20866
# @IDE : PyCharm
# @File : PycharmProject/IfFine.py
# @Description : 说明文件功能
...
def fine_product() -> list:
    ...
    for i in range(0, 2):
        ...
        for item in all_item:
            ...
            time.sleep(1)
            fine_course = pro.if_fine_product(pro)
            fine_list.append(fine_course)
...
if __name__ == '__main__':
    fine_list = fine_product()
    with open('../txtDirectory-1.0/IfFineProduct.txt', 'w', encoding='utf-8') as fp:
