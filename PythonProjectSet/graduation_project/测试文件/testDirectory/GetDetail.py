# -*- coding: utf-8 -*-
# @CreateTime : 2023/2/15 13:34
# @Author : 20866
# @IDE : PyCharm
# @File : PycharmProject/GetDetail.py
# @Description : 说明文件功能
...
def get_detail() -> list:
    ...
    for i in range(0, 2):
        ...
        for item in all_item:
            ...
            time.sleep(1)
            detail_course = pro.get_course_detail(pro)
            detail_list.append(detail_course)
...
if __name__ == '__main__':
    course_detail_list = get_detail()
    with open('CourseDetail.txt', 'w', encoding='utf-8') as fp:
        for item in course_detail_list:
            fp.write(item)
            fp.write('\n')
