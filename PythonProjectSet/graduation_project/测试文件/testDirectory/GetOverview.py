# -*- coding: utf-8 -*-
# @CreateTime : 2023/2/15 13:46
# @Author : 20866
# @IDE : PyCharm
# @File : PycharmProject/GetOverview.py
# @Description : 说明文件功能
...
def get_overview() -> list:
    ...
    for i in range(0, 2):
        ...
        for item in all_item:
            ...
            time.sleep(1)
            overview_course = pro.get_course_overview(pro)
            overview_list.append(overview_course)
...
if __name__ == '__main__':
    course_overview_list = get_overview()
    with open('CourseOverview.txt', 'w', encoding='utf-8') as fp:
        for item in course_overview_list:
            fp.write(item)
            fp.write('\n')
    print('course detail save successfully.')
